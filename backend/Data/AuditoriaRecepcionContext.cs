...
namespace AuditoriaRecepcion.Data
{
    ...
    {
        public AuditoriaRecepcionContext(DbContextOptions<AuditoriaRecepcionContext> options)
            : base(options)
        {
        }
        ...
        public DbSet<Models.AuditoriaRecepcion> AuditoriasRecepcion { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // AuditoriaRecepcion
            modelBuilder.Entity<Models.AuditoriaRecepcion>(entity =>
            {
                ...
                entity.HasOne(e => e.Proveedor)
                    ...
                    .HasForeignKey(e => e.ProveedorID)
                    .OnDelete(DeleteBehavior.Restrict);
                entity.HasOne(e => e.UsuarioAuditor)
                    .WithMany()
                    .HasForeignKey(e => e.UsuarioAuditorID)
                    .OnDelete(DeleteBehavior.Restrict);
            });
            ...
            modelBuilder.Entity<Evidencia>(entity =>
            {
                ...
                entity.HasOne(e => e.Auditoria)
                    ...
                    .HasForeignKey(e => e.AuditoriaID)
                    .OnDelete(DeleteBehavior.Cascade);
                entity.HasOne(e => e.DetalleAuditoria)
                    .WithMany()
                    .HasForeignKey(e => e.DetalleAuditoriaID)
                    .OnDelete(DeleteBehavior.Restrict);
            });
            ...
            modelBuilder.Entity<Rol>().HasData(
                ...
                new Rol
                {
                    RolID = 2,
                    NombreRol = "Auditor",
                    Descripcion = "Puede realizar auditorías y gestionar incidencias",
                    Permisos = "auditorias,incidencias,productos,proveedores",
                    FechaCreacion = DateTime.Now,
                    Activo = true
                },
                new Rol
                {
                    ...
                    Descripcion = "Puede supervisar auditorías y generar reportes",
                    Permisos = "auditorias:read,incidencias,reportes,dashboard",
                    FechaCreacion = DateTime.Now,
                    Activo = true
                },
                new Rol
                {
                    ...
                    Permisos = "auditorias:read,productos:read,proveedores:read",
                    FechaCreacion = DateTime.Now,
                    Activo = true
                }
            );
            ...
            modelBuilder.Entity<Usuario>().HasData(
                new Usuario
                {
                    ...
                    Email = "admin@auditoria-recepcion.com",
                    ContrasenaHash = "$2a$11$X8ZqYJZGqZqYJZGqZqYJZOqZqYJZGqZqYJZGqZqYJZGqZqYJZGqZq", // Hash de "Admin123!"
                    RolID = 1,
                    Rol = "Administrador",
                    Activo = true,
                    FechaCreacion = DateTime.Now
